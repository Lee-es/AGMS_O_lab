...
import kr.co.uxn.agms.ui.dialog.CurrentRangeDialog;
import kr.co.uxn.agms.ui.dialog.GraphCycleDialog;
...
public class SettingFragment extends BaseFragment {
    ...
    Button buttonCancel;
    Button buttonSend;
    Button buttonRangeSetting;
    Button buttonGraphCycleSetting;
    List<PatientData> patientDataall;

    CurrentRangeDialog rangeDialog;
    GraphCycleDialog cycleDialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buttonGraphCycleSetting=root.findViewById(R.id.button_graphupdatecyclesetting);
        ...
        buttonRangeSetting=root.findViewById(R.id.button_new_rangsetting);
...
//        });
        ...
        buttonRangeSetting.setOnClickListener(view -> {
            buttonRangeSetting.setEnabled(false);
            buttonRangeSetting.postDelayed(() -> buttonRangeSetting.setEnabled(true), 1000);
            rangeDialog=new CurrentRangeDialog(getContext());
            rangeDialog.show();
        });

        buttonGraphCycleSetting.setOnClickListener(view -> {
            buttonGraphCycleSetting.setEnabled(false);
            buttonGraphCycleSetting.postDelayed(() -> buttonGraphCycleSetting.setEnabled(true), 1000);
            cycleDialog=new GraphCycleDialog(getContext());
            cycleDialog.show();
        });
